      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link href="/sop-pmj" className="hover:underline">
                Prosedur Operasional
              </Link>
            </li>
            <li>
              <Link href="/layanan-akademis" className="hover:underline">
                Layanan
              </Link>
            </li>
            <li>
              <Link href="/berita-umum" className="hover:underline">
                Berita
              </Link>
            </li>
            <li>
              <Link href="/pmjd" className="hover:underline">
                PMJD
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link href="/layanan-non-akademis" className="hover:underline">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link href="/prosedur-penelitian" className="hover:underline">
                Prosedur Penelitian
              </Link>
            </li>
            <li>
              <Link href="/laporkan-hambatan" className="hover:underline">
                Laporkan Hambatan
              </Link>
            </li>
            <li>
              <Link href="/kunjungan" className="hover:underline">
                Kunjungan
              </Link>
            </li>
          </ul>
