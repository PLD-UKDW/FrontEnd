...
export default function AccessibilityToolbar() {
    ...
    return (
        ...
        <button
            type="button"
            className="rounded-md bg-[#19c219] hover:bg-[#16ad16] text-white px-3 py-2 shadow focus:outline-none focus-visible:ring focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0e7f0e] flex items-center gap-2"
            aria-expanded={open}
